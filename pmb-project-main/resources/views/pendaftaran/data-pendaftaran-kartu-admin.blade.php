                            ...
                            <div class="col-lg-6">
                                <center>
                                    ...
                                    <h5 style="margin-top: -0.5rem"> <strong class="d-block">PENERIMAAN MAHASISWA BARU</strong></h4>
                                        <h4 style="margin-top: -0.5rem"><strong class="d-block">Telkom University</strong></h3>
                                            <p style="margin-top: -0.5rem"><strong class="d-block">Jl. Telekomunikasi No. 1, Terusan Buah Batu Bandung , Jawa Barat, Indonesia  <br> 40257</strong></p>
                                </center>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="p-4" style="border-top: 2px solid black!important; margin-top:-2.5rem;">
                            ...
                            <div class="mb-4">
                                ...
                                <h5 style="text-indent: 0.5in;text-align: justify;">Saya yang menyatakan bahwa data yang
                                    saya isikan dalam formulir pendaftaran penerimaan mahasiswa baru Telkom University tahun 2023 adalah benar dan saya bersedia menerima ketentuan yang berlaku. Saya
