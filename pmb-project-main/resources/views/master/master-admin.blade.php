        ...
        ***********************************-->
        ...
        <div class="dlabnav">
            ...
            <div class="dlabnav-scroll">
                ...
                <div class="copyright">
                    <p><strong>PMB TelU </strong> ©
                        <script>
                            document.write(new Date().getFullYear())
                        </script> All Rights Reserved</p>
                    <p class="fs-12">Made by Kamal Fadhilah</p>
                </div>
            </div>
        </div>
        <!--**********************************
        ...
        <div class="footer">
            <div class="copyright">
                <p>Copyright ©
                    ...
                    Designed &amp; Developed by <a href="https://www.instagram.com/kamalfadhilah/" target="_blank">Kamal
                        Fadhilah</a>
                </p>
            </div>
        </div>
